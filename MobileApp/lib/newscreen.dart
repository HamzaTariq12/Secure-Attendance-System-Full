...
import 'package:start/screens/drawer_bar.dart';
...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Future<ProfileData> profileData() async {
    var response = await ApiService.getRequest('auth/profile/');
    if (response.statusCode == 200) {
      return BaseApiResponse<ProfileData>.fromJson(jsonDecode(response.body),
              (json) => ProfileData.fromJson(json)).data ??
          ProfileData();
    } else {
      return ProfileData();
    }
